...
- MicroLink: cliente Tailscale para ESP32, commit `216da3300f0493b0860247d43f7af5ce29df63a5`; licença MIT em `components/microlink/LICENSE`. O componente WireGuard/lwIP mantém BSD-3-Clause em `components/wireguard_lwip/LICENSE`.
