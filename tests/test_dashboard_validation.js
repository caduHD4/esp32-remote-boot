...
const rememberedLogin=globalThis.RemoteBootValidation.rememberedLogin;
const storeRememberedLogin=globalThis.RemoteBootValidation.storeRememberedLogin;
...
storeRememberedLogin(local,'senha123',true);
assert.equal(rememberedLogin(local),'senha123');
storeRememberedLogin(local,'',false);
assert.equal(rememberedLogin(local),'');
